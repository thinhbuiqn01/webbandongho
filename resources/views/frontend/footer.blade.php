<div class="footer bg-dark">
			...
			<div class="row">
				...
				<div class="col-md-5">
					...
					<div class="row" style="overflow: auto;">
						<div class="col-md-3 col-sm-6"><img width="90" src="{{asset('/images/logoWEB/MCK.png')}}">
						</div>
						<div class="col-md-9 col-sm-6">
							<p style="margin: 0 0 0;">Địa chỉ : 48 Cao Thắng - Thanh Bình - Hải Châu - Đà Nẵng</p>
		...
		<div class="" style="background: black;"><div class="text-center">Designed by HHH </div></div>
</div>
